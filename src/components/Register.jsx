...
const Register = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex items-center justify-center p-6 transition-colors duration-300">
      ...
      >
        <div className="glass dark:bg-slate-900/60 p-8 md:p-10 rounded-3xl shadow-2xl space-y-8 border border-white/20 dark:border-slate-800/50 relative overflow-hidden">
          <Link 
            to="/" 
